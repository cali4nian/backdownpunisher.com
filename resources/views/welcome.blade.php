...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body class="antialiased text-gray-200 bg-black font-instrument-sans">
    ...
    <main class="flex flex-col mx-auto space-y-20">
        ...
        <div class="relative z-10 flex flex-col items-center justify-center min-h-full px-4 py-4 sm:py-10">
          ...
          <div class="relative w-full max-w-xl mx-auto mb-8">
            <div id="kain-slideshow" class="flex items-center justify-center w-full h-64 overflow-hidden bg-black shadow-lg rounded-xl">
              ...
              <!-- Images -->
              <img src="{{ asset('images/seventhGradeKain.jpg') }}" alt="Kain photo 1" class="object-contain w-full h-full transition-opacity duration-700 ease-in-out slide-img" style="display:block;">
      ...
      <!-- Highlights Section -->
      <section id="highlights" class="relative min-h-screen mx-6 overflow-hidden text-left">
        <!-- Background Image with Opacity (restricted to section) -->
        <div class="pointer-events-none absolute inset-0 bg-[url('/public/images/highlightBG.jpg')] bg-cover bg-bottom opacity-30 z-0"></div>
      ...
      <!-- Contact Section -->
      <section id="contact" class="relative min-h-screen px-4 py-12 overflow-hidden text-center">
        <!-- Background Image with Opacity (restricted to section) -->
        <div class="pointer-events-none absolute inset-0 bg-[url('/public/images/contactBG.jpg')] bg-cover bg-center opacity-30 z-0"></div>
        <div class="relative z-10">
